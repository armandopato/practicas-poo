...
public class Controller
{
    ...
    private void saveCash()
    {
        ...
        JOptionPane.showMessageDialog(null, "Cash saved : $" + model.getCashString(), "Info",
    ...
    private void saveIncome()
    {
        ...
        JOptionPane.showMessageDialog(null, "Income saved : $" + model.getIncomeString(), "Info",
                JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    private void saveExpenses()
    {
        ...
        JOptionPane.showMessageDialog(null, "Expenses saved : $" + model.getExpensesString(), "Info",
                JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    private void saveInvestmentPerc()
    {
        ...
        JOptionPane.showMessageDialog(null, "Investment % saved : " + model.getInvestmentPercString(), "Info",
                JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    private void showDetails()
    {
        JOptionPane.showMessageDialog(null,
                "Cash: $" + model.getCashString() + "\n" +
                        ...
                        "Left Over Cash After Investments: $" + model.getLeftOverCashString(), "Details",
                JOptionPane.INFORMATION_MESSAGE);
    }
